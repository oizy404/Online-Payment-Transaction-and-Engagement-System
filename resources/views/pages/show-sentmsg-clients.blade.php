...
<div class="card col-md-6 offset-md-3 mt-5 rounded show-message">
    <div class="cardheader">
        Sent Message
        <a href="{{route('clients-message')}}" class="btn-back"><i class="fas fa-times-circle"></i></a>
    </div>
    <div class="card-body">
        ...
        <div class="img-msg mt-4">
            <img src="{{asset('img_msgclients')}}/{{$message_client->msg_imagefile}}" id="image-msg" alt="image msg" style="max-width:380px;">
        </div>
    </div>
</div>
@stop